...
const CATEGORY_DEFS = [
  ...
  },
  {
    ...
    name: "Душевые трапы",
    position: 3,
    keywords: ["душевой трап", "трап для душа"],
  },
  {
    slug: "dushevye-kabiny",
    name: "Душевые кабины/ограждения",
    position: 4,
    keywords: ["душевая кабина", "душевой уголок", "душевое ограждение"],
  },
  {
    slug: "dushevye-sistemy",
    name: "Душевые системы",
    position: 5,
    keywords: ["душевой набор", "гарнитур", "верхний душ", "душевая лейка", "лейка"],
  },
  {
    slug: "smesiteli",
    name: "Смесители",
  ...
  },
  {
    ...
    position: 13,
    keywords: ["держатель", "кронштейн", "шланг", "монтажный набор", "подключение для"],
  },
  {
    slug: "zerkala",
    name: "Зеркала",
  ...
  },
  {
    ...
    position: 15,
    keywords: ["скрытая часть", "картридж", "запчасть", "комплектующ"],
  },
  {
    slug: "armatura",
    name: "Арматура",
  ...
  },
  {
    ...
    name: "Ванны",
    position: 18,
    keywords: ["ванна акриловая", "ванна стальная", "ванна чугунная", "акриловая ванна"],
  },
  {
    slug: "prochee",
    name: "Прочее",
